  ...
  const SCHEMAS = {
    news: {
      ...
      fields: [
        ...
        { n: "bodyImage1", l: "In-article image 1", t: "image", help: "Optional — appears about one-third of the way down the article." },
        { n: "bodyImage1Caption", l: "Image 1 caption", t: "text", help: "Optional caption shown beneath in-article image 1." },
        { n: "bodyImage2", l: "In-article image 2", t: "image", help: "Optional — appears about two-thirds of the way down the article." },
        { n: "bodyImage2Caption", l: "Image 2 caption", t: "text", help: "Optional caption shown beneath in-article image 2." },
      ...
      def: () => ({ title: "", category: "General Football News", excerpt: "", body: "<p></p>", metaDescription: "", keywords: [], cover: "", bodyImage1: "", bodyImage1Caption: "", bodyImage2: "", bodyImage2Caption: "", author: "Time Grid FC", tags: [], status: "published", publishedAt: new Date().toISOString() }),
    },
    players: {
